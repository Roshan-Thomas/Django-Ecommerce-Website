    ...
    def post(self, *args, **kwargs):
        ...
        try:
            ...
            if form.is_valid():
                ...
                # Default Shipping Address Logic
...
class PaymentView(View):
    ...
    def post(self, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            amount = int(order.get_total() * 100)  # this value is in cents
            ...
            try:
                ...
                # Assign reference code for each payment
    ...
    def post(self, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            # store the refund
                ...
                messages.info(
                    self.request, "Your request has been receieved. We will get back to you in 24 Hours")
